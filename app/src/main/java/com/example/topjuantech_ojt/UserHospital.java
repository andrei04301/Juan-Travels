...
public class UserHospital extends NavigationDrawer implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.activity_user_hospital, null, false);
        drawer.addView(v, 0);
        ...
        myAdapter = new MyAdapter(UserHospital.this, userArrayList);
        user = new User();
        ...
        btnProceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (chosenRegion.equals("Select Your Region")) {
                    Toast.makeText(UserHospital.this, "Please select your Region from the list", Toast.LENGTH_LONG).show();
                    txtRegion.setError("Region is required");      //To set error on TextView
                } else if (chosenCity.equals("Select Your Province/City")) {
                    Toast.makeText(UserHospital.this, "Please select your Province/City from the list", Toast.LENGTH_LONG).show();
