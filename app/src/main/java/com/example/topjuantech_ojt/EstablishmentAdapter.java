...
public class EstablishmentAdapter extends RecyclerView.Adapter<EstablishmentAdapter.MyViewHolder> {
    ...
    public EstablishmentAdapter(Context context, ArrayList<User> userArrayList) {
        ...
        public MyViewHolder(@NonNull View itemView){
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(v.getContext(), Franchise.class);
                    intent.putExtra("AdminID", model.getAdminID());
                    intent.putExtra("EstablishmentType", model.getEstablishmentType());
