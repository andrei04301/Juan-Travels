...
public class UserGas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdapter = new MyAdapter(UserGas.this, userArrayList);
        user = new User();
        ...
        btnProceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (chosenRegion.equals("Select Your Region")) {
                    Toast.makeText(UserGas.this, "Please select your Region from the list", Toast.LENGTH_LONG).show();
                    txtRegion.setError("Region is required");      //To set error on TextView
                } else if (chosenCity.equals("Select Your Province/City")) {
                    Toast.makeText(UserGas.this, "Please select your Province/City from the list", Toast.LENGTH_LONG).show();
