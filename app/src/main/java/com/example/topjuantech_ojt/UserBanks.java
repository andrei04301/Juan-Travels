...
public class UserBanks extends NavigationDrawer implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.activity_user_banks, null, false);
        drawer.addView(v, 0);
        ...
        myAdapter = new MyAdapter(UserBanks.this, userArrayList);
        user = new User();
        ...
        btnProceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (chosenRegion.equals("Select Your Region")) {
                    Toast.makeText(UserBanks.this, "Please select your Region from the list", Toast.LENGTH_LONG).show();
                    txtRegion.setError("Region is required");      //To set error on TextView
                } else if (chosenCity.equals("Select Your Province/City")) {
                    Toast.makeText(UserBanks.this, "Please select your Province/City from the list", Toast.LENGTH_LONG).show();
                    ...
                    db.collection(chosenRegion+"Banks").whereEqualTo("City", chosenCity).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()) {
                                for (QueryDocumentSnapshot document : task.getResult()) {
                                    ...
                                    DocumentReference uidRef = db.collection(chosenRegion+"Banks").document(uid);
                                        ...
                                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                            if (task.isSuccessful()) {
                                                ...
                                                if (document.exists()) {
                                                    ...
                                                    user = new User(establishmentName, city, document.getId(), chosenRegion+"Banks");
